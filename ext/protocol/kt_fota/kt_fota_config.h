...
#define KT_FOTA_COMMERCIAL_SVR_DM_IP "devicefota-dm.show.co.kr"
#define KT_FOTA_COMMERCIAL_SVR_DM_PORT 80
...
#define KT_FOTA_COMMERCIAL_SVR_QTY_IP "devicefota-quality-automotive.show.co.kr"
#define KT_FOTA_COMMERCIAL_SVR_QTY_PORT 80
