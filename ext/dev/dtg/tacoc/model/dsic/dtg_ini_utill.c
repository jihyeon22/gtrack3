...
int save_ini_ctrl_ip_setting_info()
{
	...
	iniparser_set(g_ini_handle, "ctrl_server_config:port", tmp);
	iniparser_set(g_ini_handle, "ctrl_server_config:server_ip", get_ctrl_server_ip_addr());
...
int save_ini_dtg_ip_setting_info()
{
	...
	iniparser_set(g_ini_handle, "dtg_server_config:server_ip", get_dtg_server_ip_addr());
...
int save_ini_ctrl_period_info()
{
	...
	iniparser_set(g_ini_handle, "ctrl_server_config:report_period", tmp);
	sprintf(tmp, "%d", get_ctrl_create_period());
	iniparser_set(g_ini_handle, "ctrl_server_config:create_period", tmp);
...
int save_ini_dtg_period_info()
{
	...
	iniparser_set(g_ini_handle, "dtg_server_config:report_period", tmp);
	sprintf(tmp, "%d", get_dtg_create_period());
	iniparser_set(g_ini_handle, "dtg_server_config:create_period", tmp);
...
int load_ini_file()
{
	...
	num = iniparser_getint(g_ini_handle, "dtg_server_config:report_period", -1);
	set_dtg_report_period(num);
	num = iniparser_getint(g_ini_handle, "dtg_server_config:create_period", -1);
	set_dtg_create_period(num);

	str = iniparser_getstring(g_ini_handle, "ctrl_server_config:server_ip", NULL);
	if(str != NULL) set_ctrl_server_ip_addr(str);
	num = iniparser_getint(g_ini_handle, "ctrl_server_config:port", -1);
	set_ctrl_server_port(num);

	num = iniparser_getint(g_ini_handle, "ctrl_server_config:report_period", -1);
	set_ctrl_report_period(num);
	num = iniparser_getint(g_ini_handle, "ctrl_server_config:create_period", -1);
