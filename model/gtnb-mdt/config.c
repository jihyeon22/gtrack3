...
void load_config_base_default(void)
{
	...
	strcpy(conf_base->common.sms_passwd, "gtnb");
}
...
{
	strcpy(config.model.report_ip, "211.106.67.26");
	config.model.report_port = 7221;
	...
	strcpy(config.model.model_name, "gtnb-mdt");
}
