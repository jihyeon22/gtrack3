...
{
	strncpy(config.model.report_ip, "hellobus.co.kr", sizeof("hellobus.co.kr"));
	config.model.report_port = 887;
	strncpy(config.model.request_ip, "hellobus.co.kr", sizeof("hellobus.co.kr"));
	...
	strncpy(config.model.model_name, "cl-mdt", sizeof("cl-mdt"));
}
