...
{
	return config.model.report_interval_keyon;

}

int get_user_cfg_keyoff_interval()
{
	return config.model.report_interval_keyoff;
}
...
{
    if ( config.model.report_interval_keyon != sec ) 
    {
        char tmp_char[32] = {0,};
        
	    config.model.report_interval_keyon = sec;
        sprintf(tmp_char,"%d",config.model.report_interval_keyon);
        save_config_user("user:report_interval_keyon", tmp_char);
    }
...
{
    if ( config.model.report_interval_keyoff != sec ) 
    {
        char tmp_char[32] = {0,};
        
	    config.model.report_interval_keyoff = sec;
        sprintf(tmp_char,"%d",config.model.report_interval_keyoff);
        save_config_user("user:report_interval_keyoff", tmp_char);
    }
