...
{
    e_RFID_INIT,
    e_NEED_TO_RFID_USER_CHK,
    e_RFID_DOWNLOAD_START,
    e_RFID_DOWNLOAD_END,
    e_RFID_USER_INFO_WRITE_TO_DEV_START,
    e_RFID_USER_INFO_WRITE_TO_DEV_SUCCESS,
    e_RFID_USER_INFO_WRITE_TO_DEV_FAIL,
