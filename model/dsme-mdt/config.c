...
void load_config_base_default(void)
{
	...
	strcpy(conf_base->common.sms_passwd, "dsmemdt");
}
...
{
	strcpy(config.model.report_ip, "152.149.8.161");
	config.model.report_port = 58733;
	...
	strcpy(config.model.model_name, "dsmemdt");
}
